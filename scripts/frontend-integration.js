 ...
 * This file demonstrates how to integrate Notesway with a web frontend
 */

// For React/Vue/Angular applications
export class NoteswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NoteswayClient(provider, contractAddress);
